...
```{r}
library(caret)
training_rows <- createDataPartition(y=modelData$IsBadBuy, p=0.5, list=FALSE)
...
```{r}
rf_01 <- ranger(IsBadBuy ~ ., data = data_training, importance = "impurity", probability = TRUE, mtry = 20, seed=42, num.trees = 2000)
print(rf_01)
