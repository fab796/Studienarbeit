...
```{r}
rf_01 <- ranger(IsBadBuy ~ ., data = modelData, importance = "permutation", probability = TRUE, seed=42)
print(rf_01)
...
```{r}
predictions_validation_01 <- predict(rf_01, data = testData, type = "response")
